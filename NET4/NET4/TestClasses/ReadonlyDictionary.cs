...
namespace NET4.TestClasses
{
        ...
        IEnumerable
    {
        ...
        ICollection IDictionary.Keys
        {
            get
            {
                return ((IDictionary) this._source).Keys;
            }
        }
        ...
        ICollection IDictionary.Values
        {
            get
            {
                return ((IDictionary) this._source).Values;
            }
        }
        ...
        object IDictionary.this[object key]
        {
            get
            {
                return ((IDictionary) this._source)[key];
            }
            set
            {
                ThrowNotSupportedException();
        ...
        bool ICollection.IsSynchronized
        {
            get
            {
                return ((ICollection) this._source).IsSynchronized;
            }
        }
        ...
        object ICollection.SyncRoot
        {
            get
            {
                return ((ICollection) this._source).SyncRoot;
            }
        }
